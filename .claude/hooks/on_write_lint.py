#!/usr/bin/env python3
"""PostToolUse(Write|Edit) hook: run make lint on source file changes.

Writes lint output to stderr when issues are found (non-zero exit).
Always exits 0 — lint hooks never block tool completion.
